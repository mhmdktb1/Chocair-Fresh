...
import { Search, Trash2, Mail, Phone, Calendar, ShoppingBag, MapPin } from "lucide-react";
            ...
            >
              ...
              <div style={{ fontSize: '0.9rem', color: '#666', marginBottom: '15px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                  ...
                  <span>{user.location && user.location.startsWith('Lat:') ? 'Location Pinned on Map' : user.location}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
