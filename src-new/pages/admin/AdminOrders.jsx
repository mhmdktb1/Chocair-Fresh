...
import { Filter, Package, CheckCircle, Truck, Clock, Trash2, Calendar, ChevronLeft, ChevronRight, Search, ArrowUpDown, XCircle, MapPin } from "lucide-react";
            ...
            <div style={{ marginBottom: '25px' }}>
              ...
              <div style={{ 
                ...
                {selectedOrder.googleMapsLink && (
                  <div style={{ display: 'flex', gap: '8px' }}>
                    <span style={{ fontWeight: 600, color: '#666', minWidth: '80px' }}>Location:</span>
                    <a 
                      href={selectedOrder.googleMapsLink} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      style={{ color: '#2196f3', fontWeight: 500, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px' }}
                    >
